...
document.addEventListener('DOMContentLoaded', () => {
    ...
    let currentUserId = null; // Variable to hold the current user ID
    ...
    function addProductToList(productName) {
        ...
        let ul = document.querySelector('.snack-list');
        if (!ul) {
    ...
    function calculateTotalCost() {
        ...
        listItems.forEach(item => {
            const pointsText = item.querySelector('.snack-details small').textContent;
            if (pointsText) {
